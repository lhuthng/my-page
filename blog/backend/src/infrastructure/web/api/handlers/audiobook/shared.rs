...
pub(crate) fn caller_id(claims: &Claims) -> Result<i64, AudiobookError> {
    claims
        .user_id
        .parse::<i64>()
...
pub(crate) fn page_window(limit: Option<i64>, offset: Option<i64>, default: i64) -> (i64, i64) {
    (
