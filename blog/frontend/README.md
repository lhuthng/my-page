...
| `BACKEND_ORIGIN`  | Public origin of the backend (e.g. `https://api.huuthangle.site`). Tells `fixClientRoute()` to build direct browser-facing media URLs. Optional - omit it and media falls back to the `/api/media/...` proxy. |
