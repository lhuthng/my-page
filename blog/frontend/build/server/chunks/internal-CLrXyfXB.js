...
async function get_hooks() {
	...
	let init;
	({handle, handleFetch, handleError, handleValidationError, init} = await import("./hooks.server-CUljuapb.js"));
	let reroute;
	let transport;
	return {
		handle,
...
//#endregion
export { app_dir, assets, base, get_hooks, options, override, private_env, public_env, read_implementation, relative, reset, set_private_env, set_public_env, set_read_implementation };
//# sourceMappingURL=internal-CLrXyfXB.js.map