...
<div class="bg-white rounded-lg mb-4">
	<div class="flex flex-col gap-2 p-4">
		...
		<h2 class="font-semibold text-center text-xl">
			Welcome back to the Field <span
				aria-hidden="true"
				class="text-sm opacity-60 font-normal whitespace-nowrap"
			>
				ヾ(＾∇＾)
			</span>
		</h2>
	...
	<div class="flex flex-col xl:flex-row justify-center bg-black w-full">
		<div>
			...
			<div class="flex justify-center">
				<span class="text-white text-center">
					Click the cats to explore
					<span aria-hidden="true" class="whitespace-nowrap opacity-70">
						(&nbsp;&nbsp;ᐛ&nbsp;&nbsp;&nbsp;)
					</span>
				</span>
			</div>
		...
		{#if lockedSelection === 0}
			...
			>
				...
				<p>
					...
					projects. It serves as the "juice" of this digital garden - the core persona responsible
					for keeping even the driest technical subjects feeling lively and moist.
				</p>

				<p>
					This field captures the intersection of programming and creativity through a wide range of
					mediums, including:
				</p>
				<ul class="list-disc list-inside">
					<li>
						<strong>Visual Arts 🎨:</strong>
						Spanning from hand-drawn raster arts and clean vector-based designs to the nostalgic precision
						of pixel-art.
					</li>
					<li>
						<strong>3D {'&'} Motion 🖼️:</strong>
						Exploring depth through 3D modeling and bringing static ideas to life with animation.
					</li>
					<li>
						<strong>Audio {'&'} Performance 🎶:</strong>
						Composing music backgrounds and custom sound effects, or sharing the process of performing
						them.
					</li>
				</ul>
				<p>
					Everything in this space is a reflection of my curiosity and the small creative sparks
					that make the work feel truly alive.
				</p>
			</div>
		{:else if lockedSelection === 1}
			...
			>
				...
				<p>
					Thắng is my personal account for sharing direct experiences, unfiltered thoughts, and
					hands-on experiments. <span
						aria-hidden="true"
						class="whitespace-nowrap opacity-60 text-sm"
					>
						( ˶ˆ꒳ˆ˵ )
					</span>
					While the other personas focus on the how or the creative juice, this space is about the person
					behind the keyboard.
					<span aria-hidden="true" class="whitespace-nowrap opacity-60 text-sm">(⌒‿⌒)</span>
				</p>
				<p>
					It is the most human corner <span
						aria-hidden="true"
						class="whitespace-nowrap opacity-60 text-sm"
					>
						♡(˃͈ દ ˂͈ ༶ )
					</span>
					of this digital garden, where I document:
				</p>
				<ul class="list-disc list-inside space-y-1">
					<li>
						<strong>
							Direct Experiences <span aria-hidden="true" class="whitespace-nowrap opacity-60">
								( ´ ▿ ` )
							</span>
							:
						</strong>
						Real-world reflections on my journey, my work experiences, and the lessons learned along the
						way.
						<span aria-hidden="true" class="whitespace-nowrap opacity-50 text-sm">(。・ω・。)</span>
					</li>
					<li>
						<strong>
							Unfiltered Thoughts <span aria-hidden="true" class="opacity-60 whitespace-nowrap">
								{'☆(>ᴗ•)/'}
							</span>
							:
						</strong>
						A place for raw ideas and "small creative sparks"
						<span aria-hidden="true" class="whitespace-nowrap opacity-60 text-sm">(*´▽`*)</span>
						before they are polished into a final system or project.
					</li>
					<li>
						<strong>
							Hands-on Experiments <span aria-hidden="true" class="opacity-60 whitespace-nowrap">
								(°▽°)
							</span>
							:
						</strong>
						Documentation of the various experiments I run in my spare time,
						<span aria-hidden="true" class="whitespace-nowrap opacity-60 text-sm">(ง •̀_•́)ง</span>
						reflecting my pure curiosity.
						<span aria-hidden="true" class="whitespace-nowrap opacity-50 text-sm">(•̀ᴗ•́)و</span>
					</li>
				</ul>
				<p>
					This section captures the process of learning <span
						aria-hidden="true"
						class="whitespace-nowrap opacity-60 text-sm"
					>
						(@_@;)
					</span>
					and living, ensuring the site remains a true personal archive rather than just a static portfolio.
					<span aria-hidden="true" class="whitespace-nowrap opacity-60 text-sm">_(:3 」∠)_</span>
				</p>
			</div>
		{:else if lockedSelection === 2}
			...
			>
				...
				<p>
					...
					implementation, and platform infrastructure. This section serves as a technical repository
					for engineering documentation and system management.
				</p>
				<p>The core focus areas include:</p>
				<ul class="list-disc list-inside">
					<li>
						<strong>System Structure:</strong>
						Documentation of the platform's codebase and structural design.
					</li>
					<li>
						<strong>Technical Implementation:</strong>
						Detailed "how-why" guides and deep dives into specific engineering challenges.
					</li>
					<li>
						<strong>Infrastructure Management:</strong>
						Oversight of the platform's deployment.
						<span aria-hidden="true" class="whitespace-nowrap opacity-60 text-sm font-normal">
							(ˊ•͈ ꇴ •͈ˋ)
						</span>
					</li>
				</ul>
				<p>
					While other personas address personal or creative content, The Architect ensures the
					underlying systems remain stable, documented, and functional.
				</p>
			</div>
		{/if}
	</div>
	<div class="flex not-xl:flex-col">
		<div class="space-y-2 p-4">
			...
			<p>
				The entire ecosystem is hosted on a VPS, utilizing a decoupled architecture to handle
				different functional requirements:
			</p>
			<ul class="list-disc list-inside">
				<li>
					<strong>Blog (this site):</strong>
					Built with Svelte 5 / SvelteKit 2 and Rust, containerized with Docker, and utilizing SQLite
					for data persistence.
					<img class="w-60 h-auto mx-auto rounded-lg" src="stack.webp" alt="web-stack" />
				</li>
				<li>
					<strong>Portfolio:</strong>
					A dedicated static site built with React, Lottie, and GSAP for high-performance animations
				</li>
				<li>
					<strong>WebSocket Server:</strong>
					Managed via Node.js for my apps' real-time communication
				</li>
				<li>
					<strong>Mail Server:</strong>
					Custom-built using Rust
				</li>
			</ul>
			...
			<p>
				Detailed documentation regarding the architectural decisions, deployment pipelines, and the
				evolution of this stack will be covered in the series <a
					class="text-nowrap font-semibold text-accent-blue"
					href="/series/the-artifact-manifest"
				>
					[ THE ARTIFACT MANIFEST ]
				</a>
				. You can find the initial blueprint
				<a class="font-semibold text-accent-blue" href="/posts/i-made-a-blog">here</a>
				.
			</p>
		</div>
		<div class="xl:min-w-120 space-y-2 p-4">
			...
			<ul>
				...
				<li>
					...
					Aseprite, Clip Studio Paint, Adobe Illustrator, Boxy SVG Editor, Lottie Creator.
				</li>
				<li>
