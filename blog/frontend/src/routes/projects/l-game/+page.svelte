<script>
	...
	let imageUrl = $derived(page.url.origin + '/html/l-game/l-game-thumbnail.png');
	let description =
	...
	<div class="w-full flex flex-col gap-2 bg-white rounded-xl p-4">
		...
		<div>
			...
			<ol class="list-decimal list-inside">
				<li>
					<span>
						Move the L: On your turn, you must move your L-piece to a new position (it can be
						flipped or rotated).
					</span>
				</li>
				<li>
					<span>
						Move a coin (Optional): After moving your L, you may move one of the two neutral coin to
						any empty square on the grid.
					</span>
				</li>
				<li>
					<span>
						Winning: You win if your opponent is blocked and cannot place their L-piece anywhere
						else on the board.
					</span>
				</li>
			</ol>
