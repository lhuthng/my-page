...
const VALID_TABLES = ['users', 'posts', 'comments', 'media', 'series', 'tags', 'categories'];

/**
 * Build the GraphQL variables object for a given table and filter state.
 */
function buildVariables(table, { limit, offset, search, status, role, includeDeleted }) {
...
export async function load(event) {
	...
	const includeDeleted = event.url.searchParams.get('includeDeleted') === 'true';
