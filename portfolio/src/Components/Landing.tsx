...
const coolEmojis = [gear, robot, rocket, coffee];

export default function Landing() {
  const breathInTime = 50,
    breathOutTime = 25,
    waitTime = 2000;
  ...
  const [onStartedBreathOut, onStoppedBreathOut, onEndedBreathOut] =
    useInterval();
  ...
  useEffect(() => {
    const startBI = () => {
      ...
      setRole((role) => {
        ...
        if (
          targetRole.current === undefined ||
          length === targetRole.current.length
        ) {
          isEnded = true;
          return role;
        }
  ...
  return (
    <div className="flex relative flex-col h-[max(100dvh,50rem)] lg:h-[max(100dvh,35rem)] w-full gap-10 justify-center items-center">
      <div
        className='absolute w-full h-full opacity-5 bg-[url("@/Assets/SVGs/pattern.svg")] animate-[panBackground_120s_linear_infinite]'
        style={{ backgroundSize: "25rem" }}
      />
          ...
          <div className="w-[min(37.5rem,calc(100%-1rem))] text-2xl opacity-0 animate-[fadeIn_0.5s_ease-in_forwards]">
            <div className="h-24 sm:h-auto">
              <span>
                Hi{" "}
                <Lottie
                  className="inline-block w-6 h-6 translate-y-1"
                  animationData={wink}
                  loop={true}
                />
                , my name is{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-yellow-chalk to-green-chalk">
                  Huu Thang Le
                </span>
              </span>
              <br />
              <span>
                I'm a{" "}
                <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-chalk to-purple-chalk">
                  {role}
                </span>
                {isWaiting && (
                  <span>
                    ...
                    <Lottie
                      className="inline-block w-6 h-6 translate-y-1"
                      animationData={getRandomEmoji(true)}
                      loop={true}
                    />
                  </span>
                )}
                <span
                  className={`inline-block w-0.5 h-8 bg-white-chalk ${isWaiting ? "animate-blink" : ""}`}
                >
                  &nbsp;
                </span>
              </span>
            ...
            <div className="mt-10">
              <p>
                Passionate about computer science, I've been coding and building
                projects for years. Welcome to my portfolio!
              </p>
            </div>
          </div>
          <div className="w-50 lg:w-60 h-50 lg:h-60 opacity-0 animate-[fadeIn_0.5s_ease-in_forwards]">
            <img
              className="colorful-frame w-full h-full border-5 border-transparent rounded-full"
              src={me}
            ></img>
          </div>
        </div>
        <div className="flex flex-col gap-5 mx-auto lg:mx-0 w-[min(37.5rem,calc(100%-1rem))] opacity-0 animate-[fadeIn_0.5s_ease-in_forwards]">
          <div>
            <span>
              <button className="animate-[shiftDown_0.5s_ease_forwards] px-4 h-10 rounded-3xl transition-opacity duration-200 text-darkboard duolingo-button yellow-button">
                <a href="#contact-form">Let's connect!</a>
              </button>
            </span>
          ...
          <div className="space-x-4">
            <span className="opacity-0 animate-[fadeIn_0.5s_ease-in_0.1s_forwards]">
              <a
                className="inline-block animate-[shiftDown_0.5s_ease_0.1s_forwards] w-12 h-12 duolingo-button yellow-button"
                href="https://www.linkedin.com/in/huuthangle/"
              >
                <img
                  className="w-[60%] h-full m-auto translate-x-[0.5px] filter-blackboard"
                  src={linkedin}
                ></img>
              </a>
            </span>
            <span className="opacity-0 animate-[fadeIn_0.5s_ease-in_0.2s_forwards]">
              <a
                className="inline-block animate-[shiftDown_0.5s_ease_0.2s_forwards] w-12 h-12 duolingo-button yellow-button"
                href="https://github.com/lhuthng"
              >
                <img
                  className="w-[80%] h-full m-auto translate-x-[0.5px] filter-blackboard"
                  src={github}
                ></img>
              </a>
            </span>
            <span className="opacity-0 animate-[fadeIn_0.5s_ease-in_0.3s_forwards]">
              <a
                className="inline-block animate-[shiftDown_0.5s_ease_0.3s_forwards] w-12 h-12 duolingo-button yellow-button"
                href="mailto:huuthang.l@outlook.com"
              >
                <img
                  className="w-[60%] h-full m-auto filter-blackboard"
                  src={at}
                ></img>
              </a>
            </span>
