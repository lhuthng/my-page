...
export default function Now() {
    return (<section className='flex flex-col sm:flex-row-reverse w-full h-full gap-6'>
        ...
        <div className='relative my-auto'>
            <p>Now, I'm eager to apply my skills to real-world challenges. My academic projects have prepared me to contribute confidently to development teams, and I'm actively seeking opportunities to grow, learn, and make an impact.</p>
