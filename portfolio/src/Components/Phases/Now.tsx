...
export default function Now() {
    return (<section className='flex flex-col sm:flex-row-reverse w-full h-full gap-6'>
        ...
        <div className='relative min-w-auto sm:min-w-[clamp(15rem,100dvw-30rem,25rem)] h-80 sm:h-full sm:my-auto'>
        ...
        <div className='relative my-auto'>
            <p>I'm eager to apply my skills to real-world challenges. My academic and professional projects have prepared me to contribute confidently to development teams. I'm actively seeking opportunities to grow, learn, and make an impact.</p>
