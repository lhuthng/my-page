...
export default function BSJourney() {
    return (<section className="flex flex-col lg:flex-row gap-6 sm:justify-center min-h-full">
        ...
        <div className='flex flex-col sm:flex-1 h-full justify-evenly sm:justify-center gap-6 lg:my-auto lg:gap-10'>
            <span>To build on my early passion, I pursued a B.Sc in Computer Science. This degree allowed me to dive deeper into programming, master core concepts, and tackle complex problems. I also spent a semester in Germany through a DAAD program, a valuable part of my journey.</span>
            <span>During this time <Lottie className="inline-block w-7 h-7 translate-y-1" animationData={nerd} loop={true}/>, I developed practical software engineering skills through projects that prepared me to contribute confidently to development teams.</span>
        </div>
