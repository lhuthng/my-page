...
export default function BSJourney() {
    return (<section className="flex flex-col lg:flex-row gap-6 justify-center h-full">
        <div className='flex flex-col flex-1 justify-center gap-6 lg:my-auto lg:gap-10'>
