...
export default function Work() {
    return (<div className="flex flex-col min-h-full justify-normal md:justify-center gap-6">
        <span>After a compulsory internship, I received an offer to stay on as a full-time Programmer Analyst at DXC Technology. My short assignment evolved into a chance to dive into real-world software development.</span>
        <span>Across various client projects, I honed my technical skills, adapted to new domains, and discovered how collaboration shapes better solutions. Each project felt like a new puzzle—sometimes tricky, often complex, but always rewarding.</span>
