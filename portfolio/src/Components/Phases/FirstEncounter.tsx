...
export default function FirstEncounter() {
    return (
        <section className="flex flex-col min-h-full justify-evenly text-bg-white-chalk">
            ...
            <span>So... I discovered my love for programming in middle school, drawn to the mix of logic and creativity. <code className='font-courier-prime text-yellow-chalk bg-navi-chalk'>Pascal</code> was my first language, and writing code felt like solving puzzles - each program a small win.</span>
