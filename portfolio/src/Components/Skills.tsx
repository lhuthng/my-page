    ...
    details: [
      {
        ...
        detail: (
          <div className="w-56 text-left">
            <b>Core:</b> HTML/CSS/JS, TypeScript
          </div>
        ),
        paths: [
          [-45, 60],
      ...
      },
      {
        ...
        detail: (
          <div className="w-52 text-right">
            <b>Frameworks:</b> React, AngularJS, Razor Page, Svelte 5
          </div>
        ),
        paths: [
          [135, 60],
    ...
    details: [
      {
        ...
        detail: (
          <div className="w-46 text-left">
            <b>Languages:</b> Go, C#, Rust, Python, C++, PHP
          </div>
        ),
        paths: [
          [45, 60],
      ...
      },
      {
        ...
        dy: 0,
        detail: (
          <div className="w-54 text-right">
            <b>Communication:</b> WebSocket, REST, gRPC, JSON-RPC
          </div>
        ),
        paths: [
          [180, 120],
  ...
  },
  {
    ...
    details: [
      ...
      },
      {
        ...
        detail: (
          <div className="w-36 text-left">
            <b>Auth:</b> JWT, OAuth2, Session-based auth
          </div>
        ),
        paths: [[0, 140]],
      },
      {
        ...
        detail: (
          <div className="w-46 text-right">
            <b>Servers:</b> Windows Server, Linux Server
          </div>
        ),
        paths: [
          [180, 100],
    ...
    details: [
      {
        ...
        detail: (
          <div className="w-32 text-left">
            <b>Version Control:</b> Git, GitLab, Azure Repos
          </div>
        ),
        paths: [
          [45, 22],
      ...
      },
      {
        ...
        detail: (
          <div className="w-20 text-right">
            <b>CI/CD:</b> Jenkins, Github Actions
          </div>
        ),
        paths: [
          [-135, 22],
      ...
      },
      {
        ...
        detail: (
          <div className="w-22 text-right">
            <b>Testing:</b> unittest, junit, MSTest
          </div>
        ),
        paths: [
          [180, 40],
    ...
    details: [
      {
        ...
        detail: (
          <div className="w-52 text-left">
            <b>Databases:</b> PostgreSQL, MySQL, OracleDB, MongoDB
          </div>
        ),
        paths: [
          [45, 80],
      ...
      },
      {
        ...
        detail: (
          <div className="w-48 text-right">
            <b>Concepts:</b> Schema Design, Data Modeling, Indexing
          </div>
        ),
        paths: [
          [135, 80],
  ...
  },
  {
    ...
    children: [
      <div className="relative w-full h-full [&>div]:absolute [&>div]:w-full [&>div]:h-full bg-white">
        ...
        />
        <div
          className="illustration-foreground"
          style={{
      ...
      <p
        style={{
          backgroundImage:
            "linear-gradient(-30deg,red,orange,yellow,violet,orange,yellow,violet)",
          backgroundClip: "text",
    ...
    details: [
      {
        ...
        detail: (
          <div className="w-42 text-right">
            <b>Digital Art:</b> Clip Studio Paint, Adobe Photoshop, Illustrator,
            Aseprite
          </div>
        ),
        paths: [
      ...
      },
      {
        ...
        detail: (
          <div className="w-42 text-left">
            <b>Video Production:</b> Adobe Premiere, After Effects, Blender
          </div>
        ),
        paths: [
          [-45, 22],
      ...
      },
      {
        ...
        detail: (
          <div className="w-42 text-left">
            <b>Music Production:</b> FL Studio
          </div>
        ),
        paths: [
          [0, 60],
      ...
      },
      {
        ...
        detail: (
          <div className="w-44 text-right">
            <b>Programming Tools:</b> Visual Studio, Visual Studio Code
          </div>
        ),
        paths: [
          [90, 20],
      ...
      },
      {
        ...
        detail: (
          <div className="w-46 text-left">
            <b>Game Programming:</b> Unity, Game Maker Studio 2
          </div>
        ),
        paths: [
          [45, 55],
...
export default function Skills() {
  ...
  return (
    <section className="max-w-340 mx-auto">
      ...
      <div
        className="relative max-w-200 mx-auto py-20 bg-amber-50 text-darkboard space-y-10"
        style={{
          maskImage:
      ...
      >
        <i
          className="absolute right-0 top-10 w-80 h-80 bg-yellow-chalk-dark opacity-20"
          style={{
            maskRepeat: "no-repeat",
            maskImage: `url(${svelte})`,
          }}
        />
        <h1 className="px-10 py-4 font-bold text-4xl bg-red-700/90 text-white">
          What I Do
        </h1>
        <div className="flex flex-col px-10 gap-6">
          <blockquote className="pl-10 text-xl space-y-10 ">
            <h2 className="skill-quote relative text-2xl w-fit pl-4 font-bold">
              "Jack of all trades, master of none."
            </h2>
            <p className="italic text-justify [&>b]:font-bold">
              Some believe true mastery is found only in a single craft. I hold
              a different view. The finest creations are not born from one
              skill, but from the artful union of many. I have apprenticed in
              the arts of <b>the architect</b> and <b>the engineer</b>,{" "}
              <b>the illuminator</b> and <b>the storyteller</b>, allowing me to
              forge singular works, expertly wrought from foundation to
              flourish.
            </p>
          </blockquote>
          <i className="text-md text-gray-chalk-dark">
            *To explore each skill in detail, interact with the cards below*
          </i>
        </div>
      </div>
      <div className="relative grid-container w-full" ref={gridRef}>
        ...
        <i
          className="card-holder absolute w-full top-15 bottom-10 bg-amber-100/90 z-8"
          style={{
            maskImage: `radial-gradient(rgba(0,0,0,0.6), black)`,
          }}
        />
        {!isSmall && selection !== undefined && cards[selection] && (
          <div className="relative col-span-full z-9" key={selection}>
            <Card
              {...cards[selection]}
        ...
        {cards.map((props, index) => (
          <div className="relative z-9" key={index}>
            {isSmall || selection !== index ? (
              <Card
                {...props}
                isSmall={isSmall}
      ...
      <div
        className="relative skills-section-remark max-w-200 mx-auto bg-amber-50 text-darkboard p-10 pt-30 mb-20 space-y-10"
        style={{
      ...
      >
        <div className="space-y-10">
          ...
          <p className="text-xl italic">
            These cards represent the skills I command. The following works are
            the proof of what they can build when artfully united. If you have a
